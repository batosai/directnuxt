...
<template>
  <Head>
    ...
    <Meta
      property="og:image"
      :content="'/assets/meta_image/' + article?.seo?.og_image"
    />
    <Meta property="og:type" content="article" />

    <Meta
      name="robots"
      :content="article?.seo?.no_follow ? 'nofollow' : 'follow'"
    />
    <Meta
      name="robots"
      :content="article?.seo?.no_index ? 'noindex' : 'index'"
    />
    <Meta
      name="robots"
      :content="
        article?.seo?.no_follow && article?.seo?.no_index
          ? 'noindex, nofollow'
          : 'index, follow'
      "
    />
